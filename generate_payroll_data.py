#!/usr/bin/env python3
"""
Payroll & Payslips Data Generator
...
def generate_payroll_data(months_back=6, clear_existing=True):
    ...
    with app.app_context():
        ...
        for month_offset in range(months_back, 0, -1):
            # Calculate period
            period_end = date.today() - relativedelta(months=month_offset)
            # Set to last day of month
            period_end = period_end.replace(day=1) + relativedelta(months=1) - timedelta(days=1)
...
if __name__ == "__main__":
    ...
    print("🚀 Payroll & Payslips Generator")
    print("="*60)
